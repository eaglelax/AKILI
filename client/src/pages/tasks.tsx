            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    type="datetime-local"
                    className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md text-sm bg-white focus:outline-none focus:border-[#37B6E9] focus:ring-1 focus:ring-[#37B6E9]"
                    value={startDate}
